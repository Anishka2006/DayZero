const DEFAULT_API_BASE_URL = localStorage.getItem("dayzero_api_base") || (
  (window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1" || !window.location.hostname)
    ? "http://127.0.0.1:5001"
    : "https://dayzero-backend.onrender.com"
);
const API_BASE_URL = localStorage.getItem("dayzero_api_base") || "https://madap.onrender.com" || DEFAULT_API_BASE_URL;
